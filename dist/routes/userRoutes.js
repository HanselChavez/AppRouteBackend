...
router.patch("/:id", auth_1.verifyUserToken, userController.updateUser);
router.delete("/:id", auth_1.verifyUserToken, userController.deleteUser);
router.patch("/update-role/:userId", auth_1.verifyUserToken, userController.updateUserRole);
